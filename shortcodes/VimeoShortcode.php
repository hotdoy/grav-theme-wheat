...
class VimeoShortcode extends Shortcode
{
    public function init()
    {
        $this->shortcode->getHandlers()->add('vimeo', function(ShortcodeInterface $sc) {
            ...
            if (!empty($id)) {
                return '<div class="embed vimeo"><div class="video-ctn"><iframe loading="lazy" src="https://player.vimeo.com/video/'.$id.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen></iframe></div></div>';
            } 
        });
}
}